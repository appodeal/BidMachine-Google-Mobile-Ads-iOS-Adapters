...
@interface BDMRequest (DFPBidMachineFetcher)
...
@interface DFPBidMachineFetcher () <BDMRequestDelegate>
...
@implementation DFPBidMachineFetcher
...
+ (instancetype)sharedFetcher {
    static DFPBidMachineFetcher *_sharedFetcher;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedFetcher = [[DFPBidMachineFetcher alloc] initPrivately];
    });
